...
- [x] **TASK-15** — Store: División en Zustand slices · `pending-fill-after-commit` · 2026-05-18
- [ ] **TASK-16** — StrudelContext: prop drilling + estado mutable de módulo _(depende de TASK-14)_ ← siguiente
